...
ADMIN_PASSWORD = os.getenv("ADMIN_PASSWORD", "admin2024")  # Master admin password
...
ERROR_LOG_FILE = os.getenv("ERROR_LOG_PATH", os.path.join(DATA_DIR, "error.log"))
SCHEDULER_LOG_FILE = os.getenv("SCHEDULER_LOG_FILE", os.path.join(DATA_DIR, "scheduler_log.csv"))
MANUAL_PNL_FILE = os.path.join(DATA_DIR, "manual_pnl.csv")  # NEW
DB_URL = os.getenv("SCHEDULER_DB_URL", "sqlite:///scheduler.db")
...
with tabs[8]:
    ...
    **Last Updated:** {datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")}
    ...
    - 🔑 **Admin**: Full access including cache management and report regeneration
